...
if __name__ == '__main__':
    ...
    while True:
        ...
        try:
            ...
            serialised_payload='0,100,0;0,110,0;10,100,0'
        ...
        if payload['errorCode'] == 0:
            ...
            payload['data'] = {
                    ...
                    'OrientationPointCone': {
                        'UnityX': int(q[0] + k * m2[0]),
                        'UnityY': int(q[2] + k * m2[2]),
                        'UnityZ': int(q[1] + k * m2[1]),
                        },
                    'OrientationPointAxe': {
                        'UnityX': int(q[0] + k * m1[0]),
                        'UnityY': int(q[2] + k * m1[2]),
                        'UnityZ': int(q[1] + k * m1[1]),
                        },
                }
